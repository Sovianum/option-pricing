...
class OptionReplicatingPortfolio:
    def __init__(self, share_weight, bond_weight, stock_price, is_terminal=False):
...
class BinomialTree:
    ...
    #             if portfolio.is_terminal:
    #                 continue
    #
    #             portfolio_up, portfolio_down = portfolio_tree.get_children_portfolios(period_index, node_index)
    #
    #             continuation_price = (
    #                     portfolio_up.get_price() * up_probability + portfolio_down.get_price() * (1 - up_probability)
