...
class TestOption(unittest.TestCase):
    def test_long_call(self):
        ...
        self.assertEqual(option.get_payout(PriceInfo(200, 200)), 100)
        self.assertEqual(option.get_payout(PriceInfo(50, 50)), 0)
    ...
    def test_long_put(self):
        ...
        self.assertEqual(option.get_payout(PriceInfo(200, 200)), 0)
        self.assertEqual(option.get_payout(PriceInfo(50, 50)), 50)
